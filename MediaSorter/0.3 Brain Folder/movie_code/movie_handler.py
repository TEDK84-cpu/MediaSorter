...
# LOGGING SETUP:
# Configures logging to write to movie_sorter_log.txt
...
# MOVIE NAME PARSER:
# Extracts movie name and year from filenames using regex
...
# Moves a movie file to the appropriate folder with standardized naming
